...
Te trzy czynności to zarazem trzy bounded contexty: mem, komentarz i głos. Głos oddaje się i na mem, i na komentarz, więc mapa kontekstów jest potrzebna od pierwszego dnia. Potem doszły ulubione, które urosły w kolekcje. Ta lista tłumaczy późniejszy rozmiar sagi kasowania konta: każdy kontekst to osobne miejsce do posprzątania.
