...
readingTime: 3
excerpt: "The first post. On what's coming: Java, hexagon, DDD — and the fact that Claude wrote this site for me."
---
...
This site was designed and written for me by [Claude](https://claude.ai). I said what I wanted (black, grey, navy, IntelliJ vibes), it wrote the code. A bit like code review in reverse — and honestly? Faster than my usual "just one more CSS tweak".
...
On the workbench: **Hexagonal architecture in Spring** — ports, adapters, zero magic. Want to suggest a topic or argue about DDD? Write me: [jrobertgardzinski@gmail.com](mailto:jrobertgardzinski@gmail.com).

<p class="mono-comment">// it compiles. ship it.</p>
